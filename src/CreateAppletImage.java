...
public class CreateAppletImage {
	...
	public ImageIcon getImageIcon(Object parentClass, String path,
			String description, int fileSize) {
		byte buff[] = createImageArray(parentClass, path, fileSize);
	...
	private byte[] createImageArray(Object parentClass, String path,
			int fileSize) {
		int count = 0;
		BufferedInputStream imgStream = new BufferedInputStream(parentClass
